...
app.get('/api/health', (req, res) => {
    ...
    res.json({ 
        ...
        message: 'Minimal backend v4 with CORS, JWT and Trading routes',
        version: '4.0.0',
        features: ['CORS enabled', 'JWT authentication', 'Trading routes']
    });
});
...
app.get('/', (req, res) => {
    res.json({ 
        message: 'DEX Trading System - Minimal Backend v4',
        health: '/api/health',
        auth: '/api/auth/login',
...
app.listen(port, '0.0.0.0', () => {
    console.log(`🚀 Minimal backend v4 running on port ${port}`);
